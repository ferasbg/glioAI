...
train_generator=train_datagen.flow_from_directory('/root/glioAI/data/braintumordata/brain_tumor_dataset', target_size=(224,224), color_mode='rgb', shuffle=True, subset='training', batch_size=64, class_mode='categorical')
val_generator = train_datagen.flow_from_directory('/root/glioAI/data/braintumordata/brain_tumor_dataset', target_size=(224,224), color_mode='rgb', shuffle=True, subset='validation', batch_size=64, class_mode='categorical')
